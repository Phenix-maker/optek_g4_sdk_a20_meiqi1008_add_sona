...
#define XT_STK_EXIT             0x00    /* exit point for dispatch */
...
#define XT_SOL_PC               0x00    /* return address */
#define XT_SOL_PS               0x04
#define XT_SOL_NEXT             0x08    /* next unused offset */
                                /* there may be some unused space here */
...
#define XT_SOL_PC               0x00    /* return address (b30-31=callinc) */
#define XT_SOL_PS               0x04
#define XT_SOL_NEXT             0x08    /* next unused offset */
                                /* there may be some unused space here */
