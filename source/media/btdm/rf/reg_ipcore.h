...
#define REG_IPCORE_BASE_ADDR 0x17000000

#define BLE_RADIOPWRUPDN0_ADDR 0x17000880
#define BLE_RADIOPWRUPDN1_ADDR 0x17000884
#define BLE_RADIOPWRUPDN2_ADDR 0x17000888
#define BLE_RADIOPWRUPDN3_ADDR 0x1700088C

#define BLE_RADIOTXRXTIM0_ADDR 0x17000890
#define BLE_RADIOTXRXTIM1_ADDR 0x17000894
#define BLE_RADIOTXRXTIM2_ADDR 0x17000898
#define BLE_RADIOTXRXTIM3_ADDR 0x1700089C
...
__INLINE void bt_radiopwrupdn_pack(uint8_t rxpwrup, uint8_t txpwrdn, uint8_t txpwrup)
{
    REG_IP_WR(0x1700048C, ((uint32_t)rxpwrup<<16)| ((uint32_t)txpwrdn<<8)|((uint32_t)txpwrup<<0));
}


__INLINE void ble_radiotxrxtim0_pack(uint8_t rfrxtmda0, uint8_t rxpathdly0, uint8_t txpathdly0)
{
    REG_IP_WR(BLE_RADIOTXRXTIM0_ADDR, ((uint32_t)rfrxtmda0<<16)| ((uint32_t)rxpathdly0<<8)|((uint32_t)txpathdly0<<0));
}

__INLINE void ble_radiotxrxtim1_pack(uint8_t rfrxtmda1, uint8_t rxpathdly1, uint8_t txpathdly1)
{
    REG_IP_WR(BLE_RADIOTXRXTIM1_ADDR, ((uint32_t)rfrxtmda1<<16)| ((uint32_t)rxpathdly1<<8)|((uint32_t)txpathdly1<<0));
}

__INLINE void ble_radiotxrxtim2_pack(uint8_t rfrxtmda2, uint8_t rxpathdly2, uint8_t txpathdly2)
{
    REG_IP_WR(BLE_RADIOTXRXTIM2_ADDR, ((uint32_t)rfrxtmda2<<16)| ((uint32_t)rxpathdly2<<8)|((uint32_t)txpathdly2<<0));
}

__INLINE void ble_radiotxrxtim3_pack(uint8_t rfrxtmda3, uint8_t rxpathdly3, uint8_t txpathdly3)
{
    REG_IP_WR(BLE_RADIOTXRXTIM3_ADDR, ((uint32_t)rfrxtmda3<<16)| ((uint32_t)rxpathdly3<<8)|((uint32_t)txpathdly3<<0));
}

#if 1
__INLINE void ble_radiopwrupdn0_pack(uint8_t syncposition0, uint8_t rxpwrup0, uint8_t txpwrdn0, uint8_t txpwrup0)
{
    REG_IP_WR(BLE_RADIOPWRUPDN0_ADDR, (((uint32_t)syncposition0<<24)| (uint32_t)rxpwrup0<<16)| ((uint32_t)txpwrdn0<<8)|((uint32_t)txpwrup0<<0));
}
__INLINE void ble_radiopwrupdn1_pack(uint8_t syncposition1, uint8_t rxpwrup1, uint8_t txpwrdn1, uint8_t txpwrup1)
{
    REG_IP_WR(BLE_RADIOPWRUPDN1_ADDR, (((uint32_t)syncposition1<<24)| (uint32_t)rxpwrup1<<16)| ((uint32_t)txpwrdn1<<8)|((uint32_t)txpwrup1<<0));
}

__INLINE void ble_radiopwrupdn2_pack(uint8_t syncposition2, uint8_t rxpwrup2, uint8_t txpwrdn2, uint8_t txpwrup2)
{
    REG_IP_WR(BLE_RADIOPWRUPDN2_ADDR, (((uint32_t)syncposition2<<24)| (uint32_t)rxpwrup2<<16)| ((uint32_t)txpwrdn2<<8)|((uint32_t)txpwrup2<<0));
}

__INLINE void ble_radiopwrupdn3_pack(uint8_t txpwrdn3, uint8_t txpwrup3)
{
    REG_IP_WR(BLE_RADIOPWRUPDN3_ADDR, ((uint32_t)txpwrdn3<<8)|((uint32_t)txpwrup3<<0));
}

#endif

#define REG_IPCORE_COUNT 102
 ...
 * </pre>
 */
#define IP_RWDMCNTL_ADDR   0x17000000
 ...
 * </pre>
 */
#define IP_VERSION_ADDR   0x17000004
 ...
 * </pre>
 */
#define IP_INTCNTL0_ADDR   0x1700000C
 ...
 * </pre>
 */
#define IP_INTSTAT0_ADDR   0x17000010
 ...
 * </pre>
 */
#define IP_INTACK0_ADDR   0x17000014
 ...
 * </pre>
 */
#define IP_INTCNTL1_ADDR   0x17000018
...
#define IP_TIMESTAMPTGT3INTMSK_BIT    ((uint32_t)0x00000080)
#define IP_TIMESTAMPTGT3INTMSK_POS    7
...
#define IP_TIMESTAMPTGT3INTMSK_RST    0x0
...
__INLINE void ip_intcntl1_unpack(uint8_t* clknintsrmsk, uint8_t* clknintsrval, uint8_t* fifointmsk, uint8_t* timestamptgt3intmsk, uint8_t* timestamptgt2intmsk, uint8_t* timestamptgt1intmsk, uint8_t* finetgtintmsk, uint8_t* swintmsk, uint8_t* cryptintmsk, uint8_t* slpintmsk, uint8_t* clknintmsk)
{
    ...
    *timestamptgt3intmsk = (localVal & ((uint32_t)0x00000080)) >> 7;
 ...
 * </pre>
 */
#define IP_INTSTAT1_ADDR   0x1700001C
...
#define IP_TIMESTAMPTGT3INTSTAT_BIT    ((uint32_t)0x00000080)
#define IP_TIMESTAMPTGT3INTSTAT_POS    7
...
#define IP_TIMESTAMPTGT3INTSTAT_RST    0x0
...
__INLINE void ip_intstat1_unpack(uint8_t* fifointstat, uint8_t* timestamptgt3intstat, uint8_t* timestamptgt2intstat, uint8_t* timestamptgt1intstat, uint8_t* finetgtintstat, uint8_t* swintstat, uint8_t* cryptintstat, uint8_t* slpintstat, uint8_t* clknintstat)
{
    ...
    *timestamptgt3intstat = (localVal & ((uint32_t)0x00000080)) >> 7;
 ...
 * </pre>
 */
#define IP_INTACK1_ADDR   0x17000020
...
#define IP_TIMESTAMPTGT3INTACK_BIT    ((uint32_t)0x00000080)
#define IP_TIMESTAMPTGT3INTACK_POS    7
...
#define IP_TIMESTAMPTGT3INTACK_RST    0x0
...
__INLINE void ip_intack1_unpack(uint8_t* fifointack, uint8_t* timestamptgt3intack, uint8_t* timestamptgt2intack, uint8_t* timestamptgt1intack, uint8_t* finetgtintack, uint8_t* swintack, uint8_t* cryptintack, uint8_t* slpintack, uint8_t* clknintack)
{
    ...
    *timestamptgt3intack = (localVal & ((uint32_t)0x00000080)) >> 7;
 ...
 * </pre>
 */
#define IP_ACTFIFOSTAT_ADDR   0x17000024
 ...
 * </pre>
 */
#define IP_ETPTR_ADDR   0x1700002C
 ...
 * </pre>
 */
#define IP_DEEPSLCNTL_ADDR   0x17000030
 ...
 * </pre>
 */
#define IP_DEEPSLWKUP_ADDR   0x17000034
 ...
 * </pre>
 */
#define IP_DEEPSLSTAT_ADDR   0x17000038
 ...
 * </pre>
 */
#define IP_ENBPRESET_ADDR   0x1700003C
 ...
 * </pre>
 */
#define IP_FINECNTCORR_ADDR   0x17000040
 ...
 * </pre>
 */
#define IP_CLKNCNTCORR_ADDR   0x17000044
 ...
 * </pre>
 */
#define IP_DIAGCNTL_ADDR   0x17000050
 ...
 * </pre>
 */
#define IP_DIAGSTAT_ADDR   0x17000054
 ...
 * </pre>
 */
#define IP_DEBUGADDMAX_ADDR   0x17000058
 ...
 * </pre>
 */
#define IP_DEBUGADDMIN_ADDR   0x1700005C
 ...
 * </pre>
 */
#define IP_ERRORTYPESTAT_ADDR   0x17000060
 ...
 * </pre>
 */
#define IP_SWPROFILING_ADDR   0x17000064
 ...
 * </pre>
 */
#define IP_RADIOCNTL1_ADDR   0x17000074
 ...
 * </pre>
 */
#define IP_AESCNTL_ADDR   0x170000B0
 ...
 * </pre>
 */
#define IP_AESKEY31_0_ADDR   0x170000B4
 ...
 * </pre>
 */
#define IP_AESKEY63_32_ADDR   0x170000B8
 ...
 * </pre>
 */
#define IP_AESKEY95_64_ADDR   0x170000BC
 ...
 * </pre>
 */
#define IP_AESKEY127_96_ADDR   0x170000C0
 ...
 * </pre>
 */
#define IP_AESPTR_ADDR   0x170000C4
 ...
 * </pre>
 */
#define IP_TXMICVAL_ADDR   0x170000C8
 ...
 * </pre>
 */
#define IP_RXMICVAL_ADDR   0x170000CC
 ...
 * </pre>
 */
#define IP_TIMGENCNTL_ADDR   0x170000E0
 ...
 * </pre>
 */
#define IP_FINETIMTGT_ADDR   0x170000E4
 ...
 * </pre>
 */
#define IP_CLKNTGT1_ADDR   0x170000E8
 ...
 * </pre>
 */
#define IP_HMICROSECTGT1_ADDR   0x170000EC
 ...
 * </pre>
 */
#define IP_CLKNTGT2_ADDR   0x170000F0
 ...
 * </pre>
 */
#define IP_HMICROSECTGT2_ADDR   0x170000F4
...
/**
 * @brief CLKNTGT3 register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  27:00             CLKNTGT3   0x0
 * </pre>
 */
#define IP_CLKNTGT3_ADDR   0x170000F8
#define IP_CLKNTGT3_OFFSET 0x000000F8
...
// field definitions
#define IP_CLKNTGT3_MASK   ((uint32_t)0x0FFFFFFF)
#define IP_CLKNTGT3_LSB    0
#define IP_CLKNTGT3_WIDTH  ((uint32_t)0x0000001C)
...
/**
 * @brief HMICROSECTGT3 register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  09:00        HMICROSECTGT3   0x0
 * </pre>
 */
#define IP_HMICROSECTGT3_ADDR   0x170000FC
#define IP_HMICROSECTGT3_OFFSET 0x000000FC
...
// field definitions
#define IP_HMICROSECTGT3_MASK   ((uint32_t)0x000003FF)
#define IP_HMICROSECTGT3_LSB    0
#define IP_HMICROSECTGT3_WIDTH  ((uint32_t)0x0000000A)
 ...
 * </pre>
 */
#define IP_SLOTCLK_ADDR   0x17000100
#define IP_SLOTCLK_OFFSET 0x00000100
 ...
 * </pre>
 */
#define IP_FINETIMECNT_ADDR   0x17000104
#define IP_FINETIMECNT_OFFSET 0x00000104
 ...
 * </pre>
 */
#define IP_ACTSCHCNTL_ADDR   0x17000110
#define IP_ACTSCHCNTL_OFFSET 0x00000110
 ...
 * </pre>
 */
#define IP_DFANCNTL_ADDR   0x17000194
#define IP_DFANCNTL_OFFSET 0x00000194
