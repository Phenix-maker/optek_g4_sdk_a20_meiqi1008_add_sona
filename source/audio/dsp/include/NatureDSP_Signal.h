...
void * optek_bqriir_open(void * objmem, int M, const f24 * restrict coef);
void bqriir_process( bqriir_handle_t handle, f24 * restrict r,const f24 * x, int N);
