...
/* added by Optek on Jan 10th,2020 */
//#define FREE_RTOS_DEBUG

#define INTERRUPT_PROTECT_ADDED_BY_OPTEK
...
#define configCPU_CLOCK_HZ				( 2000000 ) //no use for board

/* This has impact on speed of search for highest priority */
#ifdef SMALL_TEST
#define configMAX_PRIORITIES			( 7 )
#else
#define configMAX_PRIORITIES			( 18 ) //changed by OPTEK
#endif
...
/* changed by OPTEK */
#if 1//def DSP_SONA_MODULE_ENABLE
#define configTOTAL_HEAP_SIZE			( ( size_t ) ((32 * 1024) + (128*1024)))
#else
...
#ifdef FREE_RTOS_DEBUG //changed by OPTEK
...
//configTIMER_QUEUE_LENGTH * sizeof( DaemonTaskMessage_t ): (20*16) bytes
...
#define INCLUDE_xEventGroupSetBitFromISR    1 //added by OPTEK
...
#endif //(!defined XT_SIMULATOR) && (!defined XT_BOARD)
