...
#ifdef RTOS
static void *mutex_i2c3;
#endif

static U8 word_sub_address;

#ifdef RTOS
#define I2C_MUTEX_LOCK       xSemaphoreTake( mutex_i2c3, portMAX_DELAY)
#define I2C0_MUTEX_UNLOCK     xSemaphoreGive( mutex_i2c3 )
...
void app_i2c3_init (void)
{
	...
	#ifdef RTOS
	mutex_i2c3 = xSemaphoreCreateMutex();
	#endif
...
static I2C_RETURN I2C_START (void)
{
	...
	if (I2C_DATA_PIN)
	{
		...
		I2C_CLK_LOW;
		//I2C_START_CLK_LOW_STEADY_DELAY;
...
I2C_RETURN I2C3_write (U8 i2c_addr, U8 *wbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C3 W no resp:0x%x\n\r", i2c_addr);
	}
...
I2C_RETURN I2C3_read (U8 i2c_addr, U8 *rbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
    	DBG_Printf ("I2C3 R no resp:0x%x\n\r", i2c_addr);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C3 W sub no resp:0x%x\n\r", i2c_addr);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C3 R sub no resp:0x%x\n\r", i2c_addr);
	}
