...
#ifdef RTOS
static void *mutex_i2c2;
#endif

static U8 word_sub_address;

#ifdef RTOS
#define I2C_MUTEX_LOCK       xSemaphoreTake( mutex_i2c2, portMAX_DELAY)
#define I2C0_MUTEX_UNLOCK    xSemaphoreGive( mutex_i2c2 )
...
I2C_RETURN I2C2_write (U8 i2c_addr, U8 *wbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C2 W no resp:0x%x\n\r", i2c_addr);
	}
	...
	{
		DBG_Assert(FALSE);
		DBG_Puts ("I2C2 Mutex unLock err\n\r");
	}
	#endif
...
I2C_RETURN I2C2_read (U8 i2c_addr, U8 *rbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C2 R no resp:0x%x\n\r", i2c_addr);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C2 W sub no resp:0x%x\n\r", i2c_addr);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C2 R sub no resp:0x%x\n\r", i2c_addr);
	}
