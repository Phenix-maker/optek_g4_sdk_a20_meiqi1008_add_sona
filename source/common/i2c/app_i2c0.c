...
#ifdef RTOS
static void *mutex_i2c;
#endif

static U8 word_sub_address;

#ifdef RTOS
#define I2C_MUTEX_LOCK       xSemaphoreTake( mutex_i2c, portMAX_DELAY)
#define I2C0_MUTEX_UNLOCK     xSemaphoreGive( mutex_i2c )
...
/*
* #define I2C_SCLK_PIN     GPIO0_22_INDEX
* #define I2C_SDATA_PIN    GPIO0_23_INDEX
*/
#define I2C_SCLK_PIN     I2C0_SCLK_PIN
#define I2C_SDATA_PIN    I2C0_SDATA_PIN
...
I2C_RETURN I2C0_write (U8 i2c_addr, U8 *wbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C0 W no resp:0x%x\n\r", i2c_addr);
	}
	...
	{
		DBG_Assert(FALSE);
		DBG_Puts ("I2C0 Mutex unLock err\n\r");
	}
	#endif
...
I2C_RETURN I2C0_read (U8 i2c_addr, U8 *rbuf, U16 len)
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C0 R no resp:0x%x\n\r", i2c_addr);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C0 W sub no resp:0x%x,0x%x,0x%x\n\r", i2c_addr , sub_addr, *wbuf);
	}
...
#endif
{
	...
	if (r != I2C_SUCCESS)
	{
		DBG_Printf ("I2C0 R sub no resp:0x%x\n\r", i2c_addr);
	}
